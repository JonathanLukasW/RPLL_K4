...
const List<Map<String, String>> _debugAccounts = [
  ...
  {
    'name': 'Admin BGN',
    'email': 'lukasjoo17@gmail.com',
    'password': 'sahroni123',
    'role': 'bgn',
  },
  // ADMIN SPPG
  {
    'name': 'Admin SPPG 1 (Rezky)',
    'email': 'rezkysukajaya@gmail.com',
    'password': 'sukajaya123',
    'role': 'admin_sppg',
  },
  {
    'name': 'Admin SPPG 2 (Aley)',
    'email': 'aleykaryawangi@gmail.com',
    'password': 'karyawangi123',
    'role': 'admin_sppg',
  },
  {
    'name': 'Admin SPPG 3 (Amanda)',
    'email': 'amandakayuambon@gmail.com',
    'password': 'kayuambon123',
    'role': 'admin_sppg',
  },
  // KURIR
  {
  ...
  // KOORDINATOR
  {
    'name': 'Koord SMPN6 (Vincent)',
    'email': 'vincentsmpn6@gmail.com',
    'password': 'vincent123',
    'role': 'koordinator',
  },
  {
    'name': 'Koord Bhayangkari (Arya)',
    'email': 'aryabhayangkari19@gmail.com',
    'password': 'arya123',
    'role': 'koordinator',
  },
  {
    'name': 'Koord PGRI (Deffa)',
    'email': 'deffapgri@gmail.com',
    'password': 'deffa123',
    'role': 'koordinator',
  },
  {
    'name': 'Koord Pancasila (Khaerul)',
    'email': 'khaerulpancasila@gmail.com',
    'password': 'khaerul123',
    'role': 'koordinator',
  },
  {
    'name': 'Koord Bina Wisata (Andika)',
    'email': 'andikabinawisata@gmail.com',
    'password': 'andika123',
    'role': 'koordinator',
  },
  // WALI KELAS
  ...
  {
    'name': 'Wali Kelas 11A (Jeremy)',
    'email': 'binawisata_11a@gmail.com',
    'password': 'binawisata_11a',
    'role': 'walikelas',
  },
];
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _navigateToDashboard(BuildContext context, String role) {
    if (role == 'bgn') {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => DashboardKurirScreen()),
      );
    } else if (role == 'koordinator') {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => DashboardKoordinatorScreen()),
      );
    } else if (role == 'walikelas') {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => DashboardTeacherScreen()),
      );
    } else {
      // Fallback for unknown role - this shouldn't happen with the debug list.
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("Akses Ditolak: Role '$role' tidak dikenali."),
