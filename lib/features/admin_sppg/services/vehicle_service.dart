...
// [PERBAIKAN] Join profiles untuk mendapatkan nama kurir (jika ditugaskan)
final response = await _supabase
.from('vehicles')
.select('*, profiles!left(full_name)') // Mengambil data kurir
.eq('sppg_id', mySppgId)
...
await _supabase
.from('vehicles')
.update({'is_active': !currentStatus}).eq('id', vehicleId);
} catch (e) {
