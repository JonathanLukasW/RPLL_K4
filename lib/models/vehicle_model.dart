...
final String? courierProfileId; // [BARU]
...
courierProfileId: json['courier_profile_id']?.toString(), // [BARU]
);
}
...
'is_active': isActive,
'courier_profile_id': courierProfileId, // [BARU]
};
}
}